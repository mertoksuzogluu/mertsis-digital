    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Mertsis Digital — PDKS & Yazılım",
      },
    ],
  },
  twitter: {
...
export default function RootLayout({
  ...
  const siteUrl = process.env.NEXT_PUBLIC_SITE_URL || "https://mertsisdigital.com";
  const organizationJsonLd = {
    ...
    address: {
      "@type": "PostalAddress",
      streetAddress:
        "Beylikdüzü OSB Mah. Mermerciler San. Sit. 1. Cd. No:16 Dükkan-4",
